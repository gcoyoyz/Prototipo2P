...
namespace CapaVista
{
    public partial class MDIPrincipal : Form
    {
        ...
        {
            Mantenimientos.mantenimiento1 mante = new Mantenimientos.mantenimiento1();
            mante.Show();
        }

        private void mantenimienoCursosToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Mantenimientos.Mantenimiento_Cursos mante2 = new Mantenimientos.Mantenimiento_Cursos();
            mante2.Show();
        }
        ...
        private void mantenimienoCursosToolStripMenuItem1_Click(object sender, EventArgs e)
        {
